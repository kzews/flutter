...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _saveNewApiUrl(String newUrl) async {
    try {
      ...
      // final file = File('${directory.path}/api_url.txt');

      // Перезаписываем файл с новым URL
      await file.writeAsString(newUrl);
    } catch (e) {
      print('Error saving API_URL to api_url.txt: $e');
    }
  }
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () {
                              // Сохранение нового значения API_URL в api_url.txt
                              API_URL = _apiUrl;
